...
class ItemRepositoryTest {
    ...
    public void entityManagerTest(){
        ...
        em.persist(item);//엔티티 영속성 저장
        em.flush();//db에 반영

        tx.commit();

        System.out.println("엔티티매니저 테스트 : "+em.find(Item.class, item.getId()).toString());
        em.close();
    }
...
//        System.out.println("복합키 테스트 결과"+itemRepository.findAll().toString());
//    }
}